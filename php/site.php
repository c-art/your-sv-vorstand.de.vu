         ...
         <table border=0>
          <form action=sql.php onsubmit="return checkInput(0)">'
           ."<input type=hidden name=tabname value=\"".$entry->tabname."\">
                ...
                <input type=hidden name=url value=\"site.php\">
                <input type=hidden name=mode value=\"".$entry->mode."\">
                <input type=hidden name=to_alert value=\"Deine Nachricht wurde an mail-dem-vorstand@gmx.de geschickt.\\nVielen Dank!\">

                <input type=hidden name=to_mail value=\"".$cfg_mailto."\">
                <input type=hidden name=mailfrom value=\"mail-dem-vorstand@gmx.de\">
    ...
    <tr>
     <td valign=top>
      <table>
       ...
       <tr><td><img src="../img/blank.gif" width=5 height=150 border=0></td></tr>
       <tr><td><img src="../img/bugs.gif"  border=0></td></tr>
      </table>
     </td>
     <td></td>
     <td valign=top><br><br>
      <table>
       <tr>
        <td><img src="../img/blank.gif" width=20 height=100 border=0></td>
